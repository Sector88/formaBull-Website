...
import formaBullLogo from "../../public/assets/images/logo/formaBull_logo.svg"
    ...
    render(){
        ...
        return(
            <Fragment>
                ...
                <header className="header-area formobile-menu header--fixed default-color">
                    <div className="header-wrapper" id="header-wrapper">
                        <div className="header-left">
                            <div className="logo">
                                <a href="/">
                                    {/* <img className="logo-1" src="/assets/images/logo/formaBull_logo_white-circle.png" alt="Logo Images"/> */}
                                    <img className="logo-2" src={formaBullLogo} alt="Logo Images"/>
                                </a>
                            </div>
                        </div>
                        <div className="header-right">
                            <nav className="mainmenunav d-lg-block">
                                <Scrollspy className="mainmenu" items={['home','features', 'about','team', 'GitContributions', 'contact']} currentClassName="is-current" offset={-200}>
                                    <li><a href="#home">Home</a></li>
                                    <li><a href="#features">Features</a></li>
                                    <li><a href="#about">About</a></li>
                                    {/* <li><a href="#portfolio">Portfolio</a></li> */}
                                    <li><a href="#team">Team</a></li>
                                    <li><a href="#GitContributions">Git Contributions</a></li>
                                        ...
                                        <div className="row">
                                            <div className="col-lg-12">
                                                <div className={`inner ${value.textPosition}`}>
                                                    ...
                                                    {value.buttonText ? <div className="slide-btn"><a className="rn-button-style--2 btn-primary-color" href='https://github.com/oslabs-beta/formaBull'>{value.buttonText}</a></div> : ''}
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                ...
                {/* Start Service Area  */}
                <div className="service-area creative-service-wrapper ptb--120 bg_color--1" id="features">
                    <div className="container">
                        <div className="row">
                            ...
                            <div className="row row--35 align-items-center">
                                <div className="col-lg-5">
                                    <div className="thumbnail">
                                        <img className="w-100" src="/assets/images/about/AboutUs-HazmatCharge2.png" alt="About Images"/>
                                    </div>
                                </div>
                        ...
                        <div className="row">
                            <div className="col-lg-6">
                                <div className="section-title service-style--3 text-left mb--25 mb_sm--0">
                                    <h2 className="title">Team of Engineers</h2>
                                    <p><br></br></p>
                                </div>
                            </div>
                        </div>
                ...
                <div className="rn-testimonial-area bg_color--5 ptb--120" id="GitContributions">
                    <div className="container">
                        <Testimonial />
                    </div>
                </div>
