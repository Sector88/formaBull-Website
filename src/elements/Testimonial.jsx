                        ...
                        <Tabs>
                            <TabPanel>
                                <div className="rn-testimonial-content text-center">
                                    <div className="inner">
                                        <p>We would like to announce an open invitation to our repo, to all developers interested in becoming contributors. Please use the contact form to reach out for more information! </p>
                                    </div>
                                    <div className="author-info">
                                        <h6><span> - Team formaBull </span></h6>
                                    </div>
                                </div>
                            </TabPanel>
